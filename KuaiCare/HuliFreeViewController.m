...
@interface HuliFreeViewController ()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic ,strong)UITableView *tableView;
@property (nonatomic ,strong)NSString *intro;
@property (nonatomic )CGFloat height;
@end

@implementation HuliFreeViewController
...
- (void)viewDidLoad {
    ...
    NSString *url = [NSString stringWithFormat:@"%@/app/patient/order/disclaimer",KCBaseURLString];
